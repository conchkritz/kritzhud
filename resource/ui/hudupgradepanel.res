...
{	
	...
	"SelectWeaponPanel"
	{
		...
		"ActiveTabPanel" // border around active weapon you choose to upgrade
		{
			"ControlName"	"EditablePanel"
		...
		"MouseOverTabPanel" // highlight border
		{
			"ControlName"	"EditablePanel"
		...
		"GreyedOutLabel" // no power up canteen equiped label
		{
		...
		"UpgradeItemStatsLabel"
		{
			...
			"font"			"LemonMilk7"
			"labelText"		"" // ??? why does it not have a label ???
		...
		"RespecButton" // refund upgrades button
		{
			"ControlName"	"CExButton"
